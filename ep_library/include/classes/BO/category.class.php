...
class BO_Category {
	...
	public function getDealSlug(){
		return "/deals/".strtolower(trim(preg_replace("/[^a-z]+/i","-", $this->name)))."/".$this->id."/";
	}

	public function getSlug(){
		return "/businesses/".strtolower(trim(preg_replace("/[^a-z]+/i","-", $this->name)))."/".$this->id."/";
	}
